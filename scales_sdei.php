<?php
// scales_sdei.php – Surveillance & Data Exploitation Index module

$statePath = __DIR__ . '/data/modules/SDEI_state.json';
$state = null;
...
<head>
  <meta charset="UTF-8">
  <title>Surveillance & Data Exploitation Index – SCALES Module</title>
  <style>
...
<div class="layout">
  ...
  <?php else: ?>
    ...
    <div class="section">
      <h2>How SDEI fits into SCALES</h2>
      <p style="font-size:0.9rem;">
        SDEI is a sector-specific index under the SCALES umbrella that focuses on the state’s ability to collect, link, analyze,
        and exploit data about people. High SDEI scores interact with multiple pillars:
      </p>
      <ul style="font-size:0.9rem;">
        <li>
          <strong>Speech, Media &amp; Information Space:</strong> surveillance and data exploitation can chill speech and skew
          the information environment.
        </li>
        <li>
          <strong>Coercive &amp; Security Apparatus:</strong> when data exploitation feeds into enforcement, it amplifies
          coercive capacity and targeting precision.
        </li>
        <li>
          <strong>Structural &amp; Legal Guardrails:</strong> weak legal remedies and opaque access rules erode meaningful checks
          against abuse of surveillance powers.
        </li>
      </ul>
      <p style="font-size:0.9rem;">
        In a full pipeline, SDEI would be calculated from indicators such as the breadth of data sources, degree of database
        integration, analytical tooling, access governance policies, and the availability of rights and remedies for individuals.
      </p>
    </div>
  <?php endif; ?>
